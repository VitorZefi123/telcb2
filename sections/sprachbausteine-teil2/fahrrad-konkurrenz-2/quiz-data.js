// ── Sprachbausteine Teil 2 › SOLLTE MAN NICHT DOCH BESSER AUFS FAHRRAD? ──────
...
<p style="text-align:center;font-weight:bold">Sollte man nicht doch besser aufs Fahrrad umsteigen?</p>
...
<div style="display:flex;flex-wrap:wrap;gap:8px">
  ${['A·AN','B·AUF','C·BEINAHE','D·DAFÜR','E·DANN','F·DENN','G·DÜRFEN','H·FAST','I·INNERHALB','J·KAUM','K·MÜSSEN','L·SOLLEN','M·STATT','N·VOR','O·ZUMEIST'].map(w => {
...
const OPTIONS = [
  ...
  { letter: 'M', text: 'STATT' },
  { letter: 'N', text: 'VOR' },
  { letter: 'O', text: 'ZUMEIST' },
];

const QUIZ_DATA = {
  id:            'sprachbausteine-teil2--fahrrad-konkurrenz-2',
  title:         'SOLLTE MAN NICHT DOCH BESSER AUFS FAHRRAD UMSTEIGEN? – Sprachbausteine Teil 2',
  ...
  questions: [
    ...
    },
    {
      ...
      correct: 'B',
      explanation:
        '„auf ein anderes Verkehrsmittel umzusteigen" – B AUF gehört zum trennbaren Verb „umsteigen auf" (to switch to). Die Präposition AUF ist fest mit dem Verb verbunden.',
    },
    {
      id: 33,
      text: buildText(33),
      ...
      correct: 'O',
      explanation:
        '„auf den zumeist gut ausgebauten Fahrradwegen" – O ZUMEIST (mostly/for the most part) beschreibt, dass die meisten Fahrradwege gut ausgebaut sind, aber nicht alle.',
    },
    {
      id: 34,
      text: buildText(34),
    ...
    },
    {
      ...
      correct: 'K',
      explanation:
        '„die sich ... innerhalb geschlossener Räume aufhalten müssen" – K MÜSSEN (must/have to) zeigt, dass diese Menschen gezwungen sind, den Großteil ihrer Zeit drinnen zu verbringen.',
    },
    {
      id: 37,
      text: buildText(37),
      ...
      correct: 'A',
      explanation:
        '„Ein breites Angebot an Zubehör für Fahrräder" – A AN gehört zum festen Ausdruck „ein Angebot an etwas" (a range/selection of something).',
    },
    {
      id: 38,
      text: buildText(38),
      ...
      correct: 'L',
      explanation:
        '„Schutzhelme, die das Fahrrad fast so sicher wie ein Panzer machen sollen" – L SOLLEN (are supposed to) drückt aus, dass die Schutzausrüstung laut ihrer Funktion das Fahrrad sicherer machen soll.',
    },
    {
      id: 39,
      text: buildText(39),
      ...
      correct: 'E',
      explanation:
        '„Nur wenn es regnet, dann sind die Autoschlangen wieder länger." – E DANN ist das Korrelat in der zweiteiligen Konstruktion „wenn...dann" (if...then).',
    },
    {
      id: 40,
      text: buildText(40),
      ...
      correct: 'N',
      explanation:
        '„Vor einem praktischen Wetterschutz für Radfahrer haben die Geschäfte noch nicht [Halt gemacht]" – N VOR zeigt, dass die Geschäfte beim Thema Wetterschutz für Radfahrer noch nicht aktiv geworden sind und es nicht im Sortiment haben.',
    },
  ],
};
