// ── Sprachbausteine Teil 1 › SZABO 1 (Gerhard Dietz) – Quiz Data ────────────
//
...
<p>vielen Dank für Ihr Interesse ${gap(21)} unseren Deutschkursen. Anbei erhalten Sie das angeforderte Anmeldeformular, das Sie bitte ausgefüllt an uns zurückschicken.</p>
...
<p>Außerdem finden Sie in den Unterlagen einen Fragenbogen ${gap(25)} Ihrer Freizeitinteressen. Wir werden uns bemühen, Ihnen den Aufenthalt in Leipzig so angenehm ${gap(26)} möglich zu gestalten.</p>
...
const QUIZ_DATA = {
  id:            'sprachbausteine-teil1--szabo-1',
  title:         'SZABO 1 – Sprachbausteine Teil 1',
  ...
  questions: [
    {
      ...
      correct: 'A',
      explanation:
        '„Interesse an unseren Deutschkursen" = interest in our German courses. Die feste Kollokation lautet „Interesse an + Dativ". „bei" und „in" passen nicht zu „Interesse".',
    },
    {
      id: 22,
      text: buildText(22),
      ...
      correct: 'B',
      explanation:
        '„eine Anzahlung in Höhe von € 200,–" = a deposit in the amount of €200. Die feste Formel lautet „in Höhe von + Betrag". „in Betrag" und „in Summe" sind keine standarddeutschen Wendungen.',
    },
    {
      id: 23,
      text: buildText(23),
      ...
      correct: 'B',
      explanation:
        '„Zur besserer Einschätzung" → „Zur besseren Einschätzung" = For a better assessment. „zu + Dativ" drückt Zweck aus. „Zwecks" + Genitiv ist formal-bürokratisch; „für" + Akkusativ verlangt eine andere Konstruktion.',
    },
    {
      id: 24,
      text: buildText(24),
      options: [
        { letter: 'A', text: 'angeschlossen' },
        { letter: 'B', text: 'anschließen' },
        { letter: 'C', text: 'anschließen an' },
      ],
      correct: 'B',
      explanation:
        '„Ein mündlicher Test wird sich … anschließen" = An oral test will follow. Das Verb „sich anschließen" = to follow/come after. Futur I: „wird sich … anschließen". „angeschlossen" = Partizip II (Passiv).',
    },
    {
      id: 25,
      text: buildText(25),
      ...
      correct: 'B',
      explanation:
        '„einen Fragenbogen bezüglich Ihrer Freizeitinteressen" = a questionnaire regarding your leisure interests. „bezüglich + Genitiv" = regarding/concerning. „anlässlich" = on the occasion of; „mittels" = by means of.',
    },
    {
      id: 26,
      text: buildText(26),
      ...
      correct: 'C',
      explanation:
        '„so angenehm wie möglich" = as pleasant as possible. Die Konstruktion „so [Adjektiv] wie möglich" drückt das höchste Maß aus. „als" = than (Komparativ); „wenn" = if.',
    },
    {
      id: 27,
      text: buildText(27),
      ...
      correct: 'C',
      explanation:
        '„einer Privatunterkunft" – nach „zwischen" (Dativ) und in Aufzählung mit „einem 3-Sterne-Hotel": „Privatunterkunft" ist Femininum → Dativ Singular: „einer".',
    },
    {
      id: 28,
      text: buildText(28),
      ...
      correct: 'A',
      explanation:
        '„Sobald Ihre Anmeldung bei uns eingegangen ist, erhalten Sie …" = As soon as your registration has been received, you will get … „sobald" = as soon as (temporale Konjunktion). „sofort" = immediately (Adverb, kein Konnektor); „so oft" = whenever.',
    },
    {
      id: 29,
      text: buildText(29),
      ...
      correct: 'B',
      explanation:
        '„einen Stadtplan mit Wegbeschreibung, damit Sie den Weg finden" = a city map with directions so that you can find the way. „damit" leitet einen Finalsatz ein (so that). „dafür" = for that; „dazu" = in addition to that.',
    },
    {
      id: 30,
      text: buildText(30),
      ...
      correct: 'B',
      explanation:
        '„Für weitere Fragen steht Ihnen unser Sekretariat zur Verfügung" = For further questions, our secretariat is available. Die Präposition „für" drückt hier den Bereich/Anlass aus. Die Wendung lautet „für Fragen zur Verfügung stehen".',
    },
  ],
};
